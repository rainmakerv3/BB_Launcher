...
get_target_property(_qt_imported_location Qt6::ShaderTools IMPORTED_LOCATION_RELEASE)
...
if(_qt_imported_location)
    set_property(TARGET Qt6::ShaderTools PROPERTY IMPORTED_LOCATION_RELWITHDEBINFO "${_qt_imported_location}")
endif()

# Import target "Qt6::ShaderTools" for configuration "MinSizeRel"
set_property(TARGET Qt6::ShaderTools APPEND PROPERTY IMPORTED_CONFIGURATIONS MINSIZEREL)

if(_qt_imported_location)
    set_property(TARGET Qt6::ShaderTools PROPERTY IMPORTED_LOCATION_MINSIZEREL "${_qt_imported_location}")
endif()
