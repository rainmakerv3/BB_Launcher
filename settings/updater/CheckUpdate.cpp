...
CheckUpdate::CheckUpdate(const bool showMessage, QWidget* parent)
    ...
    setWindowTitle(tr("BBLauncher Updater"));
    setFixedSize(0, 0);
...
#ifdef Q_OS_WIN
        platformString = "with_Downloader-Windows";
#elif defined(Q_OS_LINUX)
        platformString = "with_Downloader-Linux";
#elif defined(Q_OS_MAC)
        platformString = "with_Downloader-Mac";
#endif
...
void CheckUpdate::Install() {
    ...
    scriptContent = QStringLiteral(
        ...
        "unzip -o \"%2/temp_download_update.zip\" -d \"%2/\"\n"
        "sleep 2\n"
        "tar -xzf \"%2/BB_Launcher-macos-qt.tar.gz\" -C \"%3\"\n"
        "sleep 2\n"
        "rm \"%3/update.sh\"\n"
