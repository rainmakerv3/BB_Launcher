...
const QString consoleLanguageGroupBoxtext =
    "Console Language:\nSets the language that the PS4 game uses.\nIt's recommended to set this to "
    "a language the game supports, which will vary by region.";
const QString fullscreenCheckBoxtext =
...
const QString discordRPCCheckboxtext = "Enable Discord Rich Presence:\nDisplays the emulator icon "
...
const QString TrophyKeytext = "Trophy Key:\nKey used to decrypt trophies. Must be obtained from "
                              "your jailbroken console.\nMust contain only hex characters.";
const QString logTypeGroupBoxtext =
    "Log Type:\nSets whether to synchronize the output of the log window for performance. May have "
    "adverse effects on emulation.";
const QString logFiltertext =
    "Log Filter:\nFilters the log to only print specific information.\nExamples: Core "
    " : Trace  Lib.Pad : Debug Common.Filesystem : Error*"
    " : Critical\nLevels: Trace, Debug, Info, Warning, Error, Critical - in this order, a specific "
    "level silences all levels preceding it in the list and logs every level after it.";
const QString updaterComboBoxtext =
    "Update:\nRelease: Official versions released every month that may be very outdated, but are "
    "more reliable and tested.\nNightly: Development versions that have all the latest features "
...
const QString disableTrophycheckBoxtext =
    "Disable Trophy Pop-ups:\nDisable in-game trophy notifications. Trophy progress can still be "
...
const QString hideCursorGroupBoxtext =
    "Hide Cursor:\nChoose when the cursor will disappear:\nIdle: Set a time for it to disappear "
    "after being idle.\nNever: You will always see the mouse.\nAlways: you will never see "
    "the mouse.";
const QString idleTimeoutGroupBoxtext = "Hide Idle Cursor Timeout:\nThe duration (seconds) after "
