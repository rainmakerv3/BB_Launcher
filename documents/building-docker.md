# Building BB Launcher with Docker and VSCode Support

This guide explains how to build **BB Launcher** using Docker while keeping full compatibility with **VSCode** development.
...
## Step 2: Clone BB_Launcher Source

```bash
mkdir src
cd src
git clone --recursive https://github.com/rainmakerv3/BB_Launcher .

or your fork link.
```

3. Initialize submodules (If you already cloned repo):
